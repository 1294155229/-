	...
	<view>
		<view class="form u-border-top">
			<view class="form-row u-border-bottom" v-if="list">
				<view class="label-box"><view class="label">施工队分类</view></view>
			...
			<!-- <view class="form-row u-border-bottom">
				<view class="label-box"><view class="label">施工队名称</view></view>
				<view class="right-box" @tap="openCityPicker(2)"><input class="input" type="text" placeholder="请输入" placeholder-style="color:#BFBFBF" value="" /></view>
			</view> -->
			...
			<view class="form-row u-border-bottom">
				<view class="label-box"><view class="label">施工队人数</view></view>
				<view class="right-box"><input class="input" type="number"  placeholder="请输入" placeholder-style="color:#BFBFBF" v-model="form.teamNum" /></view>
			</view>
		...
		<view class="form">
			<view class="form-row u-border-bottom"><view class="title">经营范围</view></view>
			<textarea class="textarea u-border" v-model="form.runRange" placeholder="多行输入" placeholder-style="color:#BFBFBF" />
		</view>
		<view class="form">
			<view class="form-row u-border-bottom"><view class="title">备注</view></view>
			<textarea class="textarea u-border" v-model="form.remark" placeholder="多行输入" placeholder-style="color:#BFBFBF" />
		</view>
		<view class="form">
...
export default {
	...
	onLoad(options) {
		...
		this.items = data;
		this.$http.getSecondClassifyList(data.id).then(res => {
			if (res.code == 1) {
