	...
	<view>
		<view class="form u-border-top">
			<view class="form-row u-border-bottom" v-if="list">
				<view class="label-box"><view class="label">岗位分类</view></view>
			...
			<view class="form-row u-border-bottom">
				<view class="label-box"><view class="label">职位名称</view></view>
			...
			<view class="form-row u-border-bottom">
				...
				<view class="right-box" @tap="openCityPicker">
					<view class="text" :class="form.address ? '' : 'color1'">{{ form.address ? form.address : '请选择' }}</view>
					<u-icon class="icon" name="arrow-right" color="#BFBFBF" size="26"></u-icon>
				</view>
			</view>
			<view class="form-row u-border-bottom">
				...
				<view class="right-box">
					<input class="input" type="number" placeholder="请输入联系方式" maxlength="11" placeholder-style="color:#BFBFBF" v-model="form.contactWay" />
				</view>
			</view>
			<view class="form-row u-border-bottom">
				<view class="label-box"><view class="label">工作年限</view></view>
				<view class="right-box"><input class="input" type="text" placeholder="( 非必填 )请输入" placeholder-style="color:#BFBFBF" v-model="form.workTime" /></view>
			</view>

			<view class="form-row u-border-bottom">
				<view class="label-box"><view class="label">学历要求</view></view>
				<view class="right-box"><input class="input" type="text" placeholder="( 非必填 )请输入" placeholder-style="color:#BFBFBF" v-model="form.eduRequire" /></view>
			</view>

			<view class="form-row u-border-bottom">
				<view class="label-box"><view class="label">薪资范围</view></view>
				<view class="right-box"><input class="input" type="text" placeholder="请输入" placeholder-style="color:#BFBFBF" v-model="form.salaryRange" /></view>
			</view>
		</view>
		<view class="line_bar"></view>
		<view class="form">
			<view class="form-row u-border-bottom"><view class="title">岗位职责</view></view>
			<textarea class="textarea u-border" v-model="form.jobDuty" placeholder="多行输入" placeholder-style="color:#BFBFBF" />
		</view>
		<view class="form">
			<view class="form-row u-border-bottom"><view class="title">岗位要求</view></view>
			<textarea class="textarea u-border" v-model="form.jobRequire" placeholder="多行输入" placeholder-style="color:#BFBFBF" />
		</view>
		<!-- 底部添加图片 -->
		<view class="uplodImg">
...
export default {
	...
	methods: {
		...
		adddata() {
			this.$u.debounce(() => {
			let name = '';
			this.form.title ? '' : (name = name + '职位名称/');
			this.form.salaryRange ? '' : (name = name + '薪资范围/');
			this.form.jobDuty ? '' : (name = name + '岗位职责/');
			this.form.jobRequire ? '' : (name = name + '岗位要求/');
			this.shows ? '' : (name = name + '岗位分类/');
